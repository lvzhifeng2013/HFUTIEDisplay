namespace HFUTIEDisplay
{
    partial class VideoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.wmp.KeyDownEvent += new AxWMPLib._WMPOCXEvents_KeyDownEventHandler(this.wmp_KeyDownEvent);
            this.wmp.KeyPressEvent += new AxWMPLib._WMPOCXEvents_KeyPressEventHandler(this.wmp_KeyPressEvent);
            // 
            // VideoForm
            // 
